...
pub mod test {
    ...
    use feos_core::parameter::{ChemicalRecord, ParameterHetero, SegmentRecord};
    ...
    pub fn gcpcsaft() -> EosResult<(GcPcSaftParameters<f64, 1>, Arc<GcPcSaft>)> {
        ...
        let segment_records: Vec<_> = M
            ...
            .collect();
        let params = GcPcSaftEosParameters::from_segments(vec![cr], segment_records, None)?;
